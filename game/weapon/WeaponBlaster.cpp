...
void rvWeaponBlaster::chooseMods()
{
	if (!modsMade)
	{
		...
		numAttacks = temp.RandomInt(100)+1;//rand() % 10;
		//numAttacks = 100;
...
//This is where the attack happens? mattMod
/*
================
...
================
*/
//This is where the gun fucking fires: attacks() mattMod fml. Power == attack mod?
